...
class LendingMenus extends BaseController
{
	...
	public function index()
	{
		...
		return view('admin/lending_menus',$data);
	}


	public function getAllLendingMenu()
	{

		
		$allMenu = json_encode(getAllLendingMenu());
	...
	public function store()
	{
		...
		$data = [
			...
			$response = updateLendingMenu($data);
