...
<script src="<?= base_url().SITE_URL ?>assets/js/jquery-menu-editor-landing.js"></script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      jQuery(document).ready(function () {
                ...
                var url = "<?= base_url().SITE_URL ?>landingmenu/getAllLendingMenu";
                ...
                $('#btnOutput').on('click', function () {
                  ...
                  jQuery.ajax({
                    url: '<?= base_url().SITE_URL?>landingmenu/store',
                    data: data,
                    cache: false,
                    contentType: false,
                    processData: false,
