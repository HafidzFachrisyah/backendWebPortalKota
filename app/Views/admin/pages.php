...
<div class="row">
            ...
            <div class="card-header pb-0">
              ...
              <div class="row">
                <div class="col col-8 text-left">
                  <a href="<?= base_url().SITE_URL?>page/editor" class="btn btn-info btn-sm"><i class="fa fa-plus me-2"></i> New Page</a>
                </div>
      ...
      <script>
        $(window).ready(function(){
          $("#allPage").load("<?= base_url().SITE_URL ?>page/getAllPage<?= $param ?>");
          $("#pageCount").load("<?= base_url().SITE_URL ?>page/getPageCount<?= $param ?>");
        });
