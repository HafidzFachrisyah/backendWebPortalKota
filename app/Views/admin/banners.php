...
<div class="row">
            ...
            <div class="card-header pb-0">
              ...
              <div class="row">
                <div class="col col-8 text-left">
                  <a href="<?= base_url().SITE_URL?>banner/editor" class="btn btn-info btn-sm"><i class="fa fa-plus me-2"></i> New Banner</a>
                </div>
      ...
      <script>
        $(window).ready(function(){
          $("#allBanner").load("<?= base_url().SITE_URL ?>banner/getAllBanner");
           $("#pageCount").load("<?= base_url().SITE_URL ?>banner/getPageCount");
        });
